...
<div class="flex justify-start items-start">
    ...
    <form class="card-body" method="post" action="registreren.php" enctype="multipart/form-data">
        <div class="form-control">
            ...
            <input type="text" id="voornaam" name="voornaam" placeholder=First name class="input input-bordered w-full max-w-md bg-white text-black" required/>
            <label class="label">
                    <span class="label-text text-black">Last name</span>
                </label>
                <input type="text"  id="achternaam" name="achternaam" placeholder=Last name class="input input-bordered w-full max-w-md bg-white text-black" required/>
                <label class="label">
                ...
                <input type="password" id="wachtwoord" name="wachtwoord" placeholder=Password class="input input-bordered w-full max-w-md bg-white text-black" required/>
                <label class="label">
